    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-white transition-colors">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            {/* Version badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-950/50 border border-blue-300 dark:border-blue-500/20 mb-6 md:mb-8">
              <div className="w-2 h-2 rounded-full bg-blue-500 dark:bg-blue-400 animate-pulse"></div>
              <span className="text-xs md:text-sm text-blue-700 dark:text-blue-100">VERSIÓN 2.0 DISPONIBLE</span>
            </div>

            {/* Main title */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 max-w-4xl leading-tight">
              La Palabra en <span className="gradient-text">Nueva Luz</span>
            </h1>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section header */}
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Experimenta la Claridad.</h2>
            <p className="text-slate-600 dark:text-gray-400">Diseñado para el joven cristiano, fusionando fe con estética tech.</p>
          </div>

          {/* Feature cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-8 rounded-2xl bg-white dark:bg-zinc-900/50 border border-slate-200 dark:border-zinc-800/50 hover:border-blue-500/50 dark:hover:border-blue-500/30 transition-all shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-3">Estudio Profundo</h3>
            ...
            <div className="p-8 rounded-2xl bg-white dark:bg-zinc-900/50 border border-slate-200 dark:border-zinc-800/50 hover:border-blue-500/50 dark:hover:border-blue-500/30 transition-all shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Biblioteca Personal</h3>
              <p className="text-slate-600 dark:text-gray-400 leading-relaxed">
            ...
            <div className="p-8 rounded-2xl bg-white dark:bg-zinc-900/50 border border-slate-200 dark:border-zinc-800/50 hover:border-blue-500/50 dark:hover:border-blue-500/30 transition-all shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-3">Enfocado en Código</h3>
              <p className="text-slate-600 dark:text-gray-400 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 dark:border-zinc-800/50 bg-slate-50 dark:bg-zinc-950/50 py-12 md:py-16 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-6">
                <a href="#" className="text-slate-500 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Web App</Link></li>
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">iOS & Android</Link></li>
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">API Open Source</Link></li>
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Documentación</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Foro de Estudios</Link></li>
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Discord Oficial</Link></li>
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Blog de Actualizaciones</Link></li>
                <li><Link href="#" className="text-slate-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Contribuir</Link></li>
              </ul>
            </div>
          </div>

          {/* Bottom bar */}
          <div className="pt-8 border-t border-slate-200 dark:border-zinc-800/50 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex gap-6 text-xs text-slate-500 dark:text-gray-500">
              <Link href="#" className="hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Privacidad</Link>
              <Link href="#" className="hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Términos</Link>
              <Link href="#" className="hover:text-blue-500 dark:hover:text-blue-400 transition-colors">Cookies</Link>
            </div>
          </div>
        </div>
      </footer>
